      ...
      <main className="max-w-6xl mx-auto px-6 py-8">
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {articles.map((a) => (
              <Link key={a.id} href={`/articles/${a.slug}`} className="bg-gray-800 rounded-xl overflow-hidden hover:bg-gray-750 transition cursor-pointer border border-gray-700 hover:border-green-500">
