  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex items-center justify-center px-4">
      <div className="bg-gray-800 rounded-2xl shadow-2xl p-8 w-full max-w-md">
        <h1 className="text-3xl font-bold text-center mb-2">{t("forgotPassword")}</h1>
        <p className="text-center text-gray-400 mb-6">{t("forgotPasswordDesc")}</p>
        ...
        <p className="text-center text-gray-500 mt-6 text-sm">
          {t("rememberPassword")} <Link href="/login" className="text-green-400 font-semibold hover:text-green-300">{t("signIn")}</Link>
        </p>
      </div>
    </div>
  );
